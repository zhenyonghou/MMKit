...
typedef NS_ENUM(NSInteger, MMSwitchButtonState) {
    MMSwitchButtonStateOff  = 0,
    MMSwitchButtonStateOn
};

@interface MMSwitchButton : UIButton {
@protected
    __weak id _target;
    SEL _switchAction;
...
@property (nonatomic, assign) MMSwitchButtonState switchState;
