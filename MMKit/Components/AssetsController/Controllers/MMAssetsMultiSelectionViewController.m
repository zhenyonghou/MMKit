//
//  MMAssetsMultiSelectionViewController.m
//  LxAsset
//
...
#import "MMAssetsMultiSelectionViewController.h"
...
@interface MMAssetsMultiSelectionViewController () <UICollectionViewDataSource
, UICollectionViewDelegateFlowLayout
, MMSelectFlagGridCellDelegate
, MMStandardCameraManagerDelegate> {
...
@implementation MMAssetsMultiSelectionViewController
...
- (void)buildCollectionView
{
    ...
    if (!_collectionView) {
        ...
        [_collectionView registerClass:[MMImageEnableSelectGridCell class] forCellWithReuseIdentifier:kPhotoCellId];
...
{
    return [[MMAssetsHelper sharedInstance].assetPhotos count];
}

- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath
{
    MMImageEnableSelectGridCell *photoCell = [collectionView dequeueReusableCellWithReuseIdentifier:kPhotoCellId forIndexPath:indexPath];
    ALAsset *asset = [[MMAssetsHelper sharedInstance] getAssetAtIndex:indexPath.row];
...
{
    MMImageEnableSelectGridCell *photoCell = (MMImageEnableSelectGridCell*)[collectionView cellForItemAtIndexPath:indexPath];
...
- (BOOL)touchedFlagGridCell:(MMSelectFlagGridCell*)selectFlagCell shouldChangeState:(MMSwitchButtonState)select
{
    ...
    if (MMSwitchButtonStateOn == select) {
        if ([self hasReachesMaximumSelectValue]) {
