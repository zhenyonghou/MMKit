...
@implementation MMAssetsHelper


+ (MMAssetsHelper *)sharedInstance
{
    static MMAssetsHelper *_sharedInstance = nil;
    static dispatch_once_t onceToken;
    dispatch_once(&onceToken, ^{
        _sharedInstance = [[MMAssetsHelper alloc] init];
...
+ (UIImage *)getImageFromAsset:(ALAsset *)asset type:(MMAssetsHelperPhotoSizeType)nType
{
    ...
    if (nType == MMAssetsHelperPhotoSizeTypeThumbnail)
        iRef = [asset thumbnail];
    else if (nType == MMAssetsHelperPhotoSizeTypeScreen)
        iRef = [asset.defaultRepresentation fullScreenImage];
    else if (nType == MMAssetsHelperPhotoSizeTypeResolution)
    {
