...
static char MMViewControllerEntryTypeKey;
...
- (void)setEntryType:(MMViewControllerEntryType)entryType
{
    objc_setAssociatedObject(self, &MMViewControllerEntryTypeKey, @(entryType), OBJC_ASSOCIATION_RETAIN_NONATOMIC);
}

- (MMViewControllerEntryType)entryType
{
    NSNumber *val = objc_getAssociatedObject(self, &MMViewControllerEntryTypeKey);
